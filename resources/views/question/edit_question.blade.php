            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text mx-1 mb-4">
                        Edit the existing question and its associated answers by inputting the updated question and/or
                        answers in the form below before selecting 'Submit Changes'. Please note that there are a
                        <i>minimum</i> of three multiple-choice options.
                    </p>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="question_description" type="text"
                                    ...
                                    value="{{ old('question_description', $question->description) }}" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="option_a" type="text"
                                    ...
                                    value="{{ old('option_a', $question->option_a) }}" required autocomplete="option_a"">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="option_b" type="text"
                                    ...
                                    value="{{ old('option_b', $question->option_b) }}" required autocomplete="option_b">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="option_c" type="text"
                                    ...
                                    value="{{ old('option_c', $question->option_c) }}" required autocomplete="option_c">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="option_d" type="text"
                                    ...
                                    value="{{ old('option_d', $question->option_d) }}" autocomplete="option_d">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="option_e" type="text"
                                    ...
                                    value="{{ old('option_e', $question->option_e) }}" autocomplete="option_e">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="answer_key" type="text"
                                    ...
                                    value="{{ old('answer_key', $question->answer_key) }}" autocomplete="answer_key"
                                    pattern="[A-E]{1}" required>
